    ...
    <footer className="bg-[#f5f3f3] w-full border-t-0">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 px-12 py-16 max-w-screen-2xl mx-auto">
        ...
        <div className="space-y-6">
          <Link href="/" className="text-xl font-bold text-emerald-900 font-headline hover:opacity-80 transition-opacity">
            Namal University
          </Link>
          <p className="text-slate-500 font-body text-sm leading-relaxed max-w-xs mt-4">
      ...
      <div className="px-12 py-6 max-w-screen-2xl mx-auto border-t border-slate-200 text-center">
        <p className="text-slate-500 font-body text-sm">© 2024 Namal University. Knowledge for All.</p>
      </div>
    </footer>
  );
}
